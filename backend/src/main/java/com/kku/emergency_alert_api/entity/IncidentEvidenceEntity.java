...
/*
 * หลักฐานประกอบการแจ้งเหตุ (รูปภาพ / วิดีโอ / เสียง)
 *
 * ผู้แจ้งเหตุแนบหลักฐานได้ตอนสร้างรายการ
 * 1 รายการแจ้งเหตุ แนบหลักฐานได้หลายไฟล์
 *
 * ไฟล์จริงเก็บบน ImageKit CDN:
 * - imagekit_file_id → ใช้จัดการไฟล์ (ลบ/แก้ไข)
 * - file_url → CDN URL สำหรับแสดงผลฝั่ง client
 */
@Getter
@Setter
@Entity
